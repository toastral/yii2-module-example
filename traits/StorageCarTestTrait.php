...
trait StorageCarTestTrait
{

    /**
     * @var StorageDto
     */
    protected $srcGallery;
    ...
    public $routeRemoveFile = '/experience/car-test/remove-file';
     ...
     * @return string
     */
    public function getSrcGallery()
    {
        return $this->srcGallery;
    }

    /**
     * @param $value
     */
    public function setSrcGallery($value)
    {
        $this->srcGallery = $value;
    }
