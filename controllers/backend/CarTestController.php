...
use app\modules\experience\models\CarTestSearch;
...
/**
 * CarTestController implements the CRUD actions for CarTest model.
 */
class CarTestController extends Controller
{
    ...
    /**
     * Updates an existing CarTest model.
    ...
    /**
     * Deletes an existing CarTest model.
    ...
    /**
     * Finds the CarTest model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return CarTest the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = CarTest::findOne($id)) !== null) {
            return $model;
        } else {
